...
function Main() {
  ...
  return (
    ...
    >
      <div
        className={clsx([
          "xl:ms-0 shadow-xl transition-[margin,padding] duration-300 xl:shadow-none fixed top-0 start-0 z-50 side-menu group",
      ...
      >
        ...
        <div
          className={clsx([
            "fixed h-[65px] transition-[margin] duration-100 xl:ms-[275px] group-[.side-menu--collapsed]:xl:ms-[90px] mt-2 inset-x-0 top-0",
