...
function Main() {
  ...
  return (
    <div className="min-h-screen ravage bg-slate-100">
      <div
        className={clsx([
          "xl:ms-0 shadow-xl transition-[margin] duration-300 xl:shadow-none fixed top-0 start-0 z-50 side-menu group",
      ...
      >
        ...
        <div
          className={clsx([
            "bg-slate-100 z-20 relative w-[275px] border-dashed border-slate-200/80 duration-300 transition-[width] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:bg-slate-50 group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-slate-50 group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-solid group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] overflow-hidden border-e-2 h-screen flex flex-col",
          ])}
          onMouseOver={(event) => {
            event.preventDefault();
