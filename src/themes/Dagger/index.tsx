        ...
        <div className="fixed top-0 inset-x-0 z-10 h-[65px] box border-x-0 border-t-0 rounded-none flex">
          <div
            className={clsx([
              ...
              "before:content-[''] before:hidden before:xl:block before:absolute before:end-0 before:border-r before:border-dashed before:border-slate-300/70 before:h-4/6 before:group-[.side-menu--collapsed.side-menu--on-hover]:xl:border-solid before:group-[.side-menu--collapsed.side-menu--on-hover]:xl:h-full",
            ])}
            onMouseOver={(event) => {
              event.preventDefault();
