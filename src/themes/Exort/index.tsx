        ...
        <div className="fixed top-0 inset-x-0 z-10 h-[65px] box border-transparent bg-gradient-to-r from-theme-1 to-theme-2 border-x-0 border-t-0 rounded-none flex shadow-lg">
          <div
            className={clsx([
              ...
              "after:content-[''] after:start-[-1.25rem] after:bg-[1.25rem_top] after:absolute after:w-screen after:h-full after:bg-[length:100vw_65px] after:z-[-1] after:bg-gradient-to-r after:from-theme-1 after:to-theme-2",
            ])}
            onMouseOver={(event) => {
              event.preventDefault();
          ...
          >
            ...
            <a
              ...
              className="group-[.side-menu--collapsed.side-menu--on-hover]:xl:opacity-100 group-[.side-menu--collapsed]:xl:rotate-180 group-[.side-menu--collapsed]:xl:opacity-0 transition-[opacity,transform] hidden 3xl:flex items-center justify-center w-[20px] h-[20px] ms-auto text-white border rounded-full border-white/40 hover:bg-white/5"
            >
