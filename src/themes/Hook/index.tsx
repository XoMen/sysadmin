    ...
    >
      ...
      <div
        className={clsx([
          ...
          "after:content-[''] after:bg-gradient-to-b after:from-slate-100 after:to-slate-50 after:h-screen after:w-full after:fixed after:top-0 after:-ms-5 after:xl:rounded-[1.2rem/1.7rem]",
