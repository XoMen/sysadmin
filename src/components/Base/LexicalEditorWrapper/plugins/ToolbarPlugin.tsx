import HeadingToolbarPlugin from "./toolbar/HeadingToolbarPlugin";
...
export default function ToolbarPlugin({
  ...
  return (
    <div className="toolbar" ref={toolbarRef}>
      ...
      >
        <Lucide icon={isSourceView ? "Code2" : "Code"} className="w-4 h-4" />
      </button>
      <Divider />
      <button
        disabled={!canUndo}
      ...
      >
        <Lucide icon="AlignLeft" className="w-4 h-4" />
      ...
      >
        <Lucide icon="AlignCenter" className="w-4 h-4" />
      ...
      >
        <Lucide icon="AlignRight" className="w-4 h-4" />
