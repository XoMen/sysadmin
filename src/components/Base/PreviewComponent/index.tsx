  ...
  return (
    <div>
      {copyButton && (
        ...
        >
          <Lucide icon="File" className="w-4 h-4 me-2" /> {copyText}
        </Button>
      )}
      <div
        ref={highlightRef}
        ...
        <pre className="relative grid">
          <code
            className={clsx([
              ...
              "before:content-['HTML'] before:font-roboto before:font-medium before:px-4 before:py-2 before:block before:absolute before:top-0 before:end-0 before:rounded-bl before:bg-slate-200 before:bg-opacity-70 before:dark:bg-darkmode-400",
          ...
          <textarea
            ...
            value={copySource}
            onChange={() => {}}
            className="absolute w-0 h-0 p-0 -mt-1 -ms-1"
          ></textarea>
        </pre>
      </div>
    </div>
